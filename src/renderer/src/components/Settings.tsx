            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2  mt-1">
                  ...
                  {/*<button*/}
                  {/*  onClick={() => validateHdcPath(settings.hdcPath)}*/}
                  {/*  disabled={isValidatingHdc || settings.hdcAutoDetect}*/}
                  {/*  className="px-3 py-2 border rounded-lg text-sm hover:bg-muted transition-colors disabled:opacity-50 electron-no-drag"*/}
                  {/*>*/}
                  {/*  {isValidatingHdc ? (*/}
                  ...
                  {/*</button>*/}
                  {/*<button*/}
                  {/*  onClick={autoDetectHdc}*/}
                  {/*  disabled={isValidatingHdc || !settings.hdcAutoDetect}*/}
                  {/*  className="px-3 py-2 bg-primary text-primary-foreground rounded-lg text-sm hover:bg-primary/90 transition-colors disabled:opacity-50 electron-no-drag"*/}
                  {/*>*/}
                  {/*  {isValidatingHdc ? (*/}
                  {/*    <Loader2 className="w-4 h-4 animate-spin" />*/}
                  {/*  ) : (*/}
